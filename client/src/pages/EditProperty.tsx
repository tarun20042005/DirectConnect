...
type EditingForm = z.infer<typeof editingSchema>;

const indianStates = ["Andhra Pradesh", "Arunachal Pradesh", "Assam", "Bihar", "Chhattisgarh", "Goa", "Gujarat", "Haryana", "Himachal Pradesh", "Jharkhand", "Karnataka", "Kerala", "Madhya Pradesh", "Maharashtra", "Manipur", "Meghalaya", "Mizoram", "Nagaland", "Odisha", "Punjab", "Rajasthan", "Sikkim", "Tamil Nadu", "Telangana", "Tripura", "Uttar Pradesh", "Uttarakhand", "West Bengal", "Delhi"];

export default function EditProperty() {
  const [, setLocation] = useLocation();
  const [isRoute, params] = useRoute("/edit-property/:id");
  ...
  const form = useForm<EditingForm>({
  ...
  const handleSubmit = async (data: EditingForm) => {
  ...
  return (
    <div className="container mx-auto px-4 md:px-6 py-8 max-w-4xl">
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-3xl">Edit Your Property</CardTitle>
        ...
        <CardContent>
          <Form {...form}>
            <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-6">
              ...
              {currentStep === 4 && (
                <div className="space-y-4">
                  <h3 className="text-xl font-semibold">Review & Save Changes</h3>
                  <p className="text-muted-foreground">
                    Review your updated listing details before saving.
                  </p>
